...
async function answerRulesQuestion(query, options = {}) {
  ...
  const answer = rewrittenAnswer || fallbackAnswer;
  ...
  return {
    ...
    answerVerdict: deriveAnswerVerdict(rewrittenAnswer || draftDirectAnswer, finalConfidence),
