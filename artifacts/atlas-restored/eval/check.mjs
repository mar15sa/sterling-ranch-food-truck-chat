...
export function planningLayoutIssues(m){
 ...
 if(!base?.visible||!base.loaded||base.width<200||base.height<300||!base.src?.endsWith('/assets/village-master-plan.jpg'))errors.push('the official geographic map must be loaded and visible');
