...
const cases = require("../test/fixtures/community-root-holdout-3-2026-09-18.json");
...
async function main() {
  ...
  assert.equal(passed, cases.length, `${passed}/${cases.length} third untouched holdout cases passed`);
  console.log(`Third untouched holdout: ${passed}/${cases.length} passed.`);
}
