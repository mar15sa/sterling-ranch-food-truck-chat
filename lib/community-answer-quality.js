...
function scoreCommunityAnswer(question, result = {}, options = {}) {
  ...
  const value = severe ? 2 : uniqueIssues.length ? 3 : illustrativeEvidenceBoundary ? 4 : result.answerMode === "community-rules-boundary" ? 5 : /^Short answer:/i.test(answer) && /What I found:/i.test(answer) ? 5 : 4;
  return {
    score: value,
