...
function presentationArtifactIssues(answer = "") {
  ...
  if (/\bAllowed choices from the selected source\s*:/i.test(value)
    || (/^Short answer\s*:/im.test(value)
      && /^What I found\s*:/im.test(value)
      && /^Before you act\s*:/im.test(value)
      && /Open the linked official section if you need the complete wording/i.test(value))) {
