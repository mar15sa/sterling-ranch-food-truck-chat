...
function claimSupportsDetail(detail, text = "", actions = []) {
  ...
  if (detail === "permission") return /\b(?:yes|no|allowed|bars?|forbids?|disallows?|prohibited|required|requires|approval|permission|can|may|must|need to)\b/i.test(text)
