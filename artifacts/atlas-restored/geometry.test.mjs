...
const source = JSON.parse(fs.readFileSync(path.join(here, '../../../atlas-providence-worktree/artifacts/atlas-providence/data/geography.json'), 'utf8'));
const places = JSON.parse(fs.readFileSync(path.join(here, '../../../atlas-providence-worktree/artifacts/atlas-providence/data/places.json'), 'utf8'));
const directory = JSON.parse(fs.readFileSync(path.join(here, '../../../atlas-providence-worktree/artifacts/atlas-providence/data/directory.json'), 'utf8'));
