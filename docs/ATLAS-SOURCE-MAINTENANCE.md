...
Documentation impact: add this inventory and maintenance plan to the owner's Notion guide, and record Marissa's first-impression feedback in the Atlas design section. No Assistant flow or source-approval diagram changes are needed because this work does not alter those systems.
