...
function poolPartyAnswer(question, index, routingPlan) {
  ...
  return { ...buildAnswerContract({
    directAnswer: "No. The official pool FAQ says the pool is not available for rental.",
    ...
    sources: [source], status: "verified", requestedDetails: ["permission"], coveredDetails: ["permission"],
    checkedAt: source.checkedAt, answerMode: "community-proactive-pool-party",
