...
export function initDisplayPreferences({
  ...
  if (getStyle) {
    ...
    // A view change can change the normal heading size without adding a node.
    // Re-measure after those body styles settle, including the initial view.
    ...
    viewObserver.observe(documentRef.body, { attributes: true, attributeFilter: ['data-view', 'class'] });
