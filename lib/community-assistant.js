...
function unanchoredRecurringScheduleAnswer(question, result) {
  ...
  const appActions = relevantActions(question, sources, 5)
...
module.exports = { answerCommunityQuestion, bestContactContext, cleanAnswerText, conciseRecurringSchedule, contactDirectAnswer, eventsAnswer, extractiveAnswer, poolStatusAnswer, relevantActions, sourcedAnswer, unanchoredRecurringScheduleAnswer, usefulSentences };
