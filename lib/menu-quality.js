...
const VALID_MENU_ITEM_FIXTURES = [
  {
    ...
    description: "Six-inch street tacos on soft corn tortillas with options including chicken, beef, pork, chorizo, or veggie mix.",
...
const FOOD_WORD_PATTERN =
  /\b(al pastor|arepa|arepas|asada|bacon|bbq|beans|beef|bier|birria|bowl|bratwurst|burger|burrito|cake|carne|cheese|chicken|chips|chorizo|corn|cream|crema|dessert|dog|doner|dumpling|dumplings|elote|elotes|falafel|fries|garlic|gelato|gyro|gyros|ham|hot dog|ice|italian ice|kebab|knots?|lamb|lemonade|mac|meat|mozzarella|nacho|nachos|pepperoni|pierogi|pierogies|pizza|pork|pretzel|quesadilla|rice|ribs|salad|sandwich|sandwiches|sausage|shrimp|slider|sliders|soda|taco|tacos|tapas|tender|tenders|torta|veggie|wings?|wurst)\b/i;
const PAGE_FURNITURE_PATTERN =
  /\b(food trucks near|food trucks, ice cream|best of denver|food trucks in denver|recent reviews|sign up|get the streetfoodfinder app|streetfoodfinder app|more about this truck|united states|see more food|elevate your taste buds|past catering events|event organizers have booked|attendees corporate|attendees meet|visitors' reviews|request content removal|all reviews|open now|years of experience|mission statement|unparalleled customer service|outdoor seating|offers takeout|ultimate street food adventure|days a week availability|go-to spot|customer service|our mission|we pride ourselves|book catering|request a quote)\b/i;
