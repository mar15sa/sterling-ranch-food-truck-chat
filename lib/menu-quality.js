const JUNK_MENU_ITEM_FIXTURES = [
  ...
  {
    name: "Gallery",
    description: "Denver Food Truck Catering Pop-Up Station Takeover Turkish",
...
const FOOD_WORD_PATTERN =
  /\b(al pastor|arepa|arepas|asada|bacon|bbq|beans|beef|bier|birria|bowl|bratwurst|burger|burrito|cake|carne|cheese|chicken|chips|chorizo|chowder|corn|cream|crema|dessert|dog|doner|dumpling|dumplings|elote|elotes|falafel|fries|garlic|gelato|gyro|gyros|ham|hot dog|ice|italian ice|kebab|knots?|lamb|lemonade|lobster|mac|meat|mozzarella|nacho|nachos|pepperoni|pierogi|pierogies|pizza|pork|pretzel|quesadilla|queso|guac|salsa|poppers|rice|ribs|roll|rolls|salad|sandwich|sandwiches|sausage|shrimp|slider|sliders|soda|tail|taco|tacos|tapas|tostada|tostadas|tots|tender|tenders|torta|veggie|wings?|wurst)\b/i;
...
function isJunkMenuItem(item = {}) {
  ...
  if (/^(main|meet|gallery|see more food|past catering events|dinner|mission statement)$/i.test(name)) {
    return true;
  }
