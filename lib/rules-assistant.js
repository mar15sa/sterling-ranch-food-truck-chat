...
// Owner decisions constrain what extracted PDF text can become answer evidence.
// The original PDFs remain in the data files for auditability, but every indexed
// version of a reviewed supplement uses this small, approved-only description.
const OWNER_REVIEWED_SUPPLEMENT_TEXT = {
  "water-rates-2026": "2026 residential water, sanitary sewer, and stormwater schedule. Clearly labeled residential water base-rate rows: single-family detached, single-family attached/duplex, townhomes, and individually metered multifamily/apartments are $50.20 monthly for a 5/8-inch meter; the clearly labeled dual indoor-and-outdoor residential 3/4-inch-tap row is $74.95 per unit. Residential indoor-water tiers are $9.70, $11.70, and $18.55 per 1,000 gallons. Residential outdoor-water tiers are $11.65, $18.25, $24.80, and $30.55 per 1,000 gallons. Clearly labeled residential sanitary-sewer base-fee rows are $44.95 monthly, and residential indoor-water use is $12.50 per 1,000 gallons. Clearly labeled residential stormwater rows are $18.80 monthly for single-family detached and $17.50 for single-family attached/duplex, townhomes, and individually metered multifamily/apartments.",
  "tap-facility-2026": "2026 complete, clearly labeled residential tap and facility-fee rows. Dominion Water Resource Fee per unit: residential multifamily/apartments indoor-meter-only $6,150; single-family attached/duplex and townhomes $9,310; single-family detached under 5,000 square feet $9,870; single-family detached over 5,000 square feet $12,960. Total residential water-infrastructure fees: single-family detached $27,430; single-family attached/duplex, townhomes, and individually metered multifamily/apartments $18,420. Total residential sewer-tap fees: single-family detached $12,485; single-family attached/duplex, townhomes, and individually metered multifamily/apartments $8,360. Residential stormwater tap is $6,080 per unit. Residential facilities fees: single-family detached and duplex $12,395; townhomes and multifamily $10,880.",
  "cab-fees-effective-date": "2026 CAB service-fee amounts. Residential streetlight charge is $9.90 monthly for single-family, townhomes, and multifamily/apartments. Residential trash charge is $14.17 monthly for single-family and townhomes; multifamily/apartments with a separate contract are $0. Shared-driveway maintenance is $33.25 monthly and alley-load-home maintenance is $26.25 monthly. Disclosure and document fees: New Home Status Letter Bundle $225; Resale Status Letter Bundle $500; Resale Status Letter Only $175; Refinance Demand $125; Standard Questionnaire $75; Add-on Custom Questionnaire $40; Hard Copy $45; USB $30; Builder Floor Plan Review $5,000.",
  "delinquency-policy": "June 2025 Resolution No. 2025-06-01 is the collection-process source for delinquent utility, monthly, and covenant-enforcement fees. Its process provides a courtesy past-due notification three days after the invoice due date; a late fee after seven calendar days; a Late Notice Letter on day 15; and a Disconnect Notice or Lien Notice on the 10th day of the following month. Utility disconnection or a lien can follow if payment is not made by the last Wednesday of that month. Payment plans may be authorized for up to six months when the delinquent amount does not exceed $2,500. The listed charges are this resolution's fee schedule: Delinquent Account Late Fee 10% of the delinquent amount, up to $15; Late Notice Letter $5; Disconnect Notice/Lien Notice $25; 48 Hour Shut Off Notice $50; Disconnect $150; reconnect during 8:00 a.m.–3:00 p.m. $150; reconnect during 3:00 p.m.–9:00 p.m. $500; Statement of Lien Filing $250; Release of Statement of Lien $100; Payment Plan Administration $45 plus $10 per month; Returned Deposit $20.",
  "monthly-fee-overview": "Monthly-fee overview: use this overview to identify the type of recurring CAB charge and open the official fee schedule or CAB contact route for the controlling amount.",
};
...
function approvedSupplementDocument(document, parentSupplement = document) {
  ...
  const approvedText = OWNER_REVIEWED_SUPPLEMENT_TEXT[ownerReview?.decisionId];
...
function ownerReviewScopeUnavailable(query) {
  const text = String(query || "");
  if (/\b(?:master[ -]?meter|nonresidential|commercial|public school|school|construction water|irrigation)\b/i.test(text) && /\b(?:water|sewer|stormwater|rate|fee|fees|tap)\b/i.test(text)) {
    return "The approved 2026 evidence only covers complete, clearly labeled residential rows, so I can’t provide that category’s amount.";
  }
  if (/\b(?:large[ -]?meter|pool|clipped|footnote|incomplete|unlabelled|unlabeled)\b/i.test(text) && /\b(?:tap|facility|fee|fees)\b/i.test(text)) {
    return "The approved 2026 tap-and-facility evidence does not cover that row, so I can’t provide an amount.";
  }
  if (/\b(?:when|what date|effective date|take effect)\b/i.test(text) && /\b(?:2026\s+)?CAB\s+(?:service\s+)?fees?\b/i.test(text)) {
    return "I can share the approved 2026 CAB fee amounts, but I can’t verify a standalone effective date from that source.";
  }
  return "";
}
...
async function answerRulesQuestion(query, options = {}) {
  ...
  const withheldScopeMessage = ownerReviewScopeUnavailable(question);
  if (withheldScopeMessage) {
    return {
      answer: withheldScopeMessage,
