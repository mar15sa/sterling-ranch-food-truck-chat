...
const VERSION = "resident-quality-rubric-v2-unpublished";
...
function validCandidateShape(result = {}) {
  ...
  return (["need-first-candidate", "need-first-candidate-boundary"].includes(result.answerMode) || auditedSelection)
