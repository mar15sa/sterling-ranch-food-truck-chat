...
async function composeProactiveAnswer(question, proactive, options = {}) {
  ...
  const verified = verifyStructuredDraft(draft, evidenceSources);
...
async function answerCommunityQuestion(query, options = {}) {
  ...
  if (proactive) return { ...await composeProactiveAnswer(question, proactive, options), communityIntent: classifyCommunityIntent(question) };
