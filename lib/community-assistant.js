...
const { deterministicRequestedDetails, isOfficialInformationPageRequest, isReportedFindingsRequest, isWaterUsageAccessRequest, instructionalRequestShape, normalizeInterpretation, resolveInterpretationMode } = require("./community-interpretation");
