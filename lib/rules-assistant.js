...
async function answerRulesQuestion(query, options = {}) {
  ...
  // Keep the carefully grouped fee overview intact. Its subtotal and every
  // line item were calculated from the current source tables just above.
  const rewrittenAnswer = isResidentFeeOverviewQuery(question)
    ? null
