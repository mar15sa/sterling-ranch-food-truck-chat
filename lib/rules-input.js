...
const RULE_TOPIC_PATTERN = new RegExp(
  `\\b(?:${[
    ...
    "architectural|catio|colors?|decks?|fences?|flags?|garage doors?|greenhouses?|landscap\\w*|lights?|lighting|mailboxes?|ornaments?|paints?|panels?|patios?|pools?|roofs?|screens?|sheds?|signs?|solar|spa|trampolines?|trees?|yards?",
