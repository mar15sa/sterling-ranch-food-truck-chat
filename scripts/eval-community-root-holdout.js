...
const cases = require("../test/fixtures/community-root-holdout-2026-09-18.json");
...
async function main() {
  ...
  assert.equal(passed, cases.length, `${passed}/${cases.length} untouched holdout cases passed`);
  console.log(`Untouched holdout: ${passed}/${cases.length} passed.`);
}
