...
const CAPABILITIES = new Set(["pages", "forms", "services", "events", "rules", "facilities", "availability", "status", "menu", "vendor-profile"]);
const FACETS = new Set(["permission", "specification", "price", "contact", "hours", "date", "status", "action", "availability", "facility", "restriction", "submission", "event-date"]);
