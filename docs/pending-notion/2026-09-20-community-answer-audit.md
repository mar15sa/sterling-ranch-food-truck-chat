...
This entry describes an implemented, locally verified release candidate. It is not production-live evidence. The automatic rating remains unpublished and must continue to show **Not rated** until a sufficiently sized owner-labeled calibration set establishes agreement and false-positive performance.
