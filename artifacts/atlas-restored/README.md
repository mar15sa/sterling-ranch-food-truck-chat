# Sterling Ranch Atlas — photo-based place models

## Place models expansion — September 22, 2026

Current separate local preview: http://127.0.0.1:4193/. Previous version remains http://127.0.0.1:4190/. No shared-staging or production deployment.
