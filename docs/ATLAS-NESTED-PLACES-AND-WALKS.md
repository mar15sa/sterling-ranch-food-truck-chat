...
Implemented locally; staging release verification pending. Production launch remains unapproved.
...
Owner guide update targets: [Atlas inventory](https://www.notion.so/3dabf909186d8164930fc37c1865c026) and [Design reference](https://www.notion.so/3dabf909186d81b99d91ddd39861536b). Update after exact staging verification, preserve unrelated owner work. The Assistant flow and source-approval diagrams are unaffected.
