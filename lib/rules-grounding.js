...
function isGenericRetrievalDraft(draftAnswer) {
  return /\b(I found the closest matches|closest rulebook sections|appears to discuss this under|Fee-related rules appear|Utility-related rules appear)\b/i.test(
